...
function dishesFactory(data) {
    const { name, servings, ingredients, id, time, description } =
    data;
...
let searchContainer = document.querySelectorAll(".search_container");
...
const dropdownContainer = document.querySelector(".search_dropdown_container");
